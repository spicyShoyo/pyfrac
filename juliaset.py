...
class Julia:
    ...
    def solve(self):
            ...
            __global int *res_g, __global float *info_g)
        {
            ...
            float zr = info_g[0] + info_g[2] * cid;
            float zi = info_g[1] + info_g[3] * rid;

            float cr = 8e-9-.645411;
            float ci = 8e-9+.356888;
            ...
            float r_f = 255 * __cl_pow(ret, 3.0);
            float g_f = 255 * __cl_pow(ret, 0.7);
            float b_f = 255 * __cl_pow(ret, 0.5);
            int r_i = (width - 1) & (int)r_f;
            int g_i = (width - 1) & (int)g_f;
            int b_i = (width - 1) & (int)b_f;
